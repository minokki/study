...
class AccountControllerTest {
    ...
    @Test
    void ceckEmailToken_with_wrong_input() throws Exception {
    ...
    void checkEmailToken() throws Exception {
        Account account = Account.builder()   //입력값을 확인하려면 비교하려는 정보가 있어야함
                .email("test@email.com")
                .password("12345678")
                .nickname("mino")
                .build();
        Account newAccount = accountRepository.save(account);
        newAccount.generateEmailCheckToken();  //Todo generateEmailCheckToken
    ...
    void signUpSubmit_with_correct_input() throws Exception {
        mockMvc.perform(post("/sign-up")
                ...
                .andExpect(authenticated().withUsername("minho"));
